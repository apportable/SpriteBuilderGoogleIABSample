...
###Introduction
This In-App billing sample application has the same features as the Google official IAB-Sample, which you can find [here](https://code.google.com/p/marketbilling/source/browse/v3/src/com/example/android/trivialdrivesample/?r=5f6b7abfd0534acd5bfc7c14436f4500c99e0358#trivialdrivesample%253Fstate%253Dclosed). The only difference is that the app in this repository is written in Objective-C. 
...
###Configure on Google Play:
  ...
  3. In that app, create a SUBSCRIPTION item with this ID: infinite_gas
...
###Build Project in Xcode:
  1. Replace the public key in MainScene.m, line 184. Replace the string with the public key you got from step 5 of "Configure on Google Play".
  ...
  3. You will need to ensure that you are in a release configuration to upload your first apk to google play.
      This means you can't have debugging enabled in the manifest (for the uploaded apk)
